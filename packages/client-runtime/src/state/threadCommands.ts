...
export type {
  ...
  StartThreadRealtimeInput,
  AppendThreadRealtimeAudioInput,
  StopThreadRealtimeInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    startRealtime: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:realtime-start",
      execute: (input: StartThreadRealtimeInput) => startThreadRealtime(input),
      scheduler,
      concurrency,
    }),
    appendRealtimeAudio: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:realtime-append-audio",
      execute: (input: AppendThreadRealtimeAudioInput) => appendThreadRealtimeAudio(input),
      scheduler,
      concurrency,
    }),
    stopRealtime: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:realtime-stop",
      execute: (input: StopThreadRealtimeInput) => stopThreadRealtime(input),
      scheduler,
      concurrency,
    }),
  };
